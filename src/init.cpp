...
void SetupServerArgs(NodeContext& node)
{
    ...
    argsman.AddArg("-quickindex", strprintf("Setup the blockindex for quick client startup and less cpu use during runtime (default: %u)", DEFAULT_QUICKINDEX), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
