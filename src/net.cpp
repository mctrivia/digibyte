...
void CConnman::recentDandelionActivity()
{
    lastDandelionActivity = GetAdjustedTime();
}

int64_t CConnman::timeSinceDandelionActivity() const
{
    return GetAdjustedTime() - lastDandelionActivity;
}
